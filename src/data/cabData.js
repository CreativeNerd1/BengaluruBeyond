// Cab Services Data - Cars, Drivers, Pricing
...
export const drivers = [
  {
    ...
    rating: 4.9,
    totalTrips: 2500,
    specialization: ["Outstation", "Hill Stations"],
    badges: ["Top Rated", "Most Experienced"],
    verified: true,
    about: "Professional driver with excellent knowledge of South India routes. Known for safe driving and friendly nature.",
  },
  {
    id: 2,
    name: "Manoj Kumar",
    ...
    rating: 4.8,
    totalTrips: 1800,
    specialization: ["Airport Transfers", "Corporate"],
    badges: ["Punctual", "Professional"],
    verified: true,
    about: "Specialized in airport transfers and corporate travel. Always punctual and maintains high standards of service.",
  },
  {
    id: 3,
    name: "Vasanth R.",
    ...
    rating: 4.9,
    totalTrips: 3200,
    specialization: ["Long Distance", "Family Trips"],
    badges: ["Senior Driver", "Customer Favorite"],
    verified: true,
    about: "Veteran driver with a decade of experience. Perfect for family trips with focus on safety and comfort.",
  },
  {
    id: 4,
    name: "Sharath M.",
    ...
    rating: 4.7,
    totalTrips: 1200,
    specialization: ["Local Rides", "City Tours"],
    badges: ["City Expert", "Friendly"],
    verified: true,
    about: "Expert in city navigation and local sightseeing. Knows all the shortcuts and best routes in Bangalore.",
  },
];
